-- ══════════════════════════════════════════════════════════════════════════════
-- HAVEN: Fix export_elder_data RPC — remove invalid cm.recorded_at reference
-- companion_memory has created_at (not recorded_at); fix applied as hotfix migration
-- ══════════════════════════════════════════════════════════════════════════════
